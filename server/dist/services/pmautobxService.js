...
exports.getPmautobx = void 0;
const oracledb_1 = __importDefault(require("oracledb"));
const mockDataForPMAUTOBX_1 = require("../data/mockDataForPMAUTOBX");
const getPmautobx = async (plantCode, prdtTpcd, prvsName, possInfo, page = 1, pageSize = 10) => {
