...
export default function PackagingPage() {
    ...
    const fetchData = useCallback(async (searchParams: any = {}, page: number = 1) => {
        ...
        try {
            ...
            // Note: Adapt these params based on actual search requirements for Packaging
            if (searchParams.itemCode) q.set('itemCode', searchParams.itemCode);
            if (searchParams.packagingType) q.set('packagingType', searchParams.packagingType);
            ...
            const res = await fetch(`${baseUrl}/api/packaging?${q.toString()}`);
