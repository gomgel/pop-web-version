...
export default function BomPage() {
    ...
    const fetchData = useCallback(async (searchParams: any = {}, page: number = 1) => {
        ...
        try {
            ...
            // Note: Adapt these params based on actual search requirements for BOM
            if (searchParams.itemCode) q.set('itemCode', searchParams.itemCode);
            if (searchParams.bomVersion) q.set('bomVersion', searchParams.bomVersion);
            ...
            const res = await fetch(`${baseUrl}/api/bom?${q.toString()}`);
