...
export function BoxDataTable({ data, total, loading }: BoxDataTableProps) {
    return (
                ...
                <Table>
                    <TableHeader className="bg-stone-50">
                        <TableRow>
                            ...
                            <TableHead className="font-bold text-stone-700 whitespace-nowrap">
                                <div className="flex items-center gap-1 cursor-pointer hover:bg-stone-100 p-1 rounded">
                                    Print Count <ChevronsUpDown className="h-3 w-3 text-stone-400" />
                                </div>
                            </TableHead>
                            <TableHead className="font-bold text-stone-700 whitespace-nowrap">
                                <div className="flex items-center gap-1 cursor-pointer hover:bg-stone-100 p-1 rounded">
                                    MAC Valid <ChevronsUpDown className="h-3 w-3 text-stone-400" />
                                </div>
                            </TableHead>
                            <TableHead className="font-bold text-stone-700 whitespace-nowrap">
                                <div className="flex items-center gap-1 cursor-pointer hover:bg-stone-100 p-1 rounded">
                                    Quality Mark <ChevronsUpDown className="h-3 w-3 text-stone-400" />
                                </div>
                            </TableHead>
                            <TableHead className="font-bold text-stone-700 whitespace-nowrap">
                                <div className="flex items-center gap-1 cursor-pointer hover:bg-stone-100 p-1 rounded">
                                    ID Tracking <ChevronsUpDown className="h-3 w-3 text-stone-400" />
                                </div>
                            </TableHead>
                            <TableHead className="font-bold text-stone-700 whitespace-nowrap">
                                <div className="flex items-center gap-1 cursor-pointer hover:bg-stone-100 p-1 rounded">
                                    Created <ChevronsUpDown className="h-3 w-3 text-stone-400" />
                                </div>
                            </TableHead>
                        </TableRow>
                    </TableHeader>
                        ...
                        {loading ? (
                            ...
                            data.map((row, idx) => (
                                <TableRow key={`${row.v_Prdt_Tpcd}-${idx}`} className="hover:bg-blue-50/50">
                                    ...
                                    <TableCell className="py-2 text-stone-600">{row.v_Prnt_Cunt}</TableCell>
                                    <TableCell className="py-2 text-stone-600">{row.v_Vald_Macc}</TableCell>
                                    <TableCell className="py-2 text-stone-600">{row.v_Qult_Mark}</TableCell>
                                    <TableCell className="py-2 text-stone-600">{row.v_Idnt_Dvsn}</TableCell>
                                    <TableCell className="py-2 text-stone-600">
                                        {row.v_Scre_Date} {row.v_Scre_Time}
                                    </TableCell>
                                </TableRow>
                            ))
                        )}
